...
export const StorefrontHome = () => {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="text-white" style={{ backgroundColor: 'var(--brand-primary, #0f172a)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          <div className="text-center max-w-2xl mx-auto">
            <h1 className="text-3xl sm:text-5xl font-bold mb-4">
              Bienvenido a{' '}
              <span className="font-bold" style={{ color: 'var(--brand-secondary, #fbbf24)' }}>{storeName}</span>
            </h1>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link
              ...
              style={{ color: 'var(--brand-secondary, #d97706)' }}
            >
