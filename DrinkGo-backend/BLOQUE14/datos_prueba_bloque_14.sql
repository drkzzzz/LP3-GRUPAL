-- =====================================================
-- DATOS DE PRUEBA - BLOQUE 14: TIENDA ONLINE (STOREFRONT)
-- Sistema DrinkGo - Multi-tenant
-- =====================================================

-- IMPORTANTE: Ejecutar DESPUÉS de tener datos de:
-- - Negocios (negocio_id = 1, 2)
...
-- Configuración para Negocio 1: Licorería Premium (Habilitada)
...
-- Configuración para Negocio 2: Licorería Express (Deshabilitada - en configuración)
INSERT INTO configuracion_tienda_online (
    negocio_id,
    esta_habilitado,
    nombre_tienda,
...
(
    ...
    1,
    1,
    'Sobre Nosotros - DrinkGo Premium',
...
(
    ...
    1,
    3,
    'Zonas de Entrega - Cobertura de Delivery',
...
-- Páginas para Negocio 2 (Licorería Express)
INSERT INTO paginas_tienda_online (
    negocio_id,
    titulo,
    slug,
...
(
    ...
    1,
    1,
    'Próximamente - Licorería Express',
...
SELECT 
    ...
    esta_habilitado,
    creado_en
FROM configuracion_tienda_online;
