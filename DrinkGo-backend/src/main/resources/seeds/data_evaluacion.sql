-- ============================================================
-- DRINKGO - DATOS DE EVALUACIÓN
-- Archivo generado para carga automática al iniciar el backend
...
-- 4. ROLES DEL NEGOCIO
-- ============================================
INSERT IGNORE INTO roles (id, negocio_id, nombre, descripcion, es_rol_sistema, esta_activo, creado_en, actualizado_en)
VALUES
...
-- 6. USUARIOS_ROLES
-- ============================================
INSERT IGNORE INTO usuarios_roles (id, usuario_id, rol_id, asignado_en) VALUES
...
-- 8. USUARIOS_SEDES
-- ============================================
INSERT IGNORE INTO usuarios_sedes (id, usuario_id, sede_id, es_predeterminado, asignado_en) VALUES
...
-- ============================================
INSERT IGNORE INTO cajas_registradoras (
...
-- ============================================
INSERT IGNORE INTO sesiones_caja (
...
-- ============================================
INSERT IGNORE INTO stock_inventario (
...
-- 20. LOTES
-- ============================================
INSERT IGNORE INTO lotes_inventario (
    id, negocio_id, producto_id, almacen_id,
...
-- ============================================
INSERT IGNORE INTO detalle_ordenes_compra (
...
-- 25. PAGOS DE VENTAS
-- ============================================
INSERT IGNORE INTO pagos_venta (
...
-- ============================================
INSERT IGNORE INTO series_facturacion (
...
-- ============================================
INSERT IGNORE INTO documentos_facturacion (
...
-- 32. DEVOLUCIONES
-- ============================================
INSERT IGNORE INTO devoluciones (
