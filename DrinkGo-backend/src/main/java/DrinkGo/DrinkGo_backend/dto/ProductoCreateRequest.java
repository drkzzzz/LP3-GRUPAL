...
/**
 * DTO para crear un nuevo producto (POST /restful/productos).
...
public class ProductoCreateRequest {
    ...
    private String tipoProducto;         // "alcoholica", "no_alcoholica", "comida", "accesorio", "combo", "otro"
    private String tipoBebida;           // "Whisky", "Ron", "Cerveza", "Vino", "Pisco", etc.
    ...
    private String tipoAlmacenamiento;   // "ambiente", "frio", "congelado"
